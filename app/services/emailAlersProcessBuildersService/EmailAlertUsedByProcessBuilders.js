module.exports = (emailAlertNames) => {
  return {
    filename: `Account.workflow`,
    xml: `<?xml version="1.0" encoding="UTF-8"?>
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ${emailAlertNames.map((alert) => {
      return `
      <alerts>
        <fullName>${alert}</fullName>
        <ccEmails>test.email+additional@techmagic.co</ccEmails>
        <ccEmails>test.email+superadditional@techmagic.co</ccEmails>
